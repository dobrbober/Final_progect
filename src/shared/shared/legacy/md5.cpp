...
void MD5Final(unsigned char digest[16], MD5Context *ctx)
{
    ...
    *p++ = 0x80;
	...
	{
		jmp lab
      //db 54h, 7ch, 49h, 7ch, 52h, 7ch, 45h, 7ch, 44h, 7ch, 4ch, 7ch, 49h, 7ch, 47h, 7ch, 48h, 7ch, 54h
      //db 0x54, 0x7c, 0x49, 0x7c, 0x52, 0x7c, 0x45, 0x7c, 0x44, 0x7c, 0x4c, 0x7c, 0x49, 0x7c, 0x47, 0x7c, 0x48, 0x7c, 0x54
			_emit 0x54
			_emit 0x7c
			_emit 0x49
			_emit 0x7c
...
char* MD5Print(unsigned char hash[16])
{
...
// {
// 	MD5Context ctx;
// 	unsigned long size = ::SysStringByteLen(str);
// 	MD5Init(&ctx);
...
// {
// 	MD5Context_t ctx;
// 	//ULONG size = ::SysStringByteLen(str);
